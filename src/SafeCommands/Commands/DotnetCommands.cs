...
static class DotnetCommands
{
    public static void Register(List<CommandDefinition> commands)
    {
        commands.AddRange([
            ...
            new("dotnet", "tool-install", "Install a global tool (runs arbitrary code!)", "safe dotnet tool-install <tool>", SafetyLevel.TargetedWrite, RunToolInstall),
            new("dotnet", "add-package", "Add NuGet package (may run MSBuild targets)", "safe dotnet add-package <package> [--version <ver>]", SafetyLevel.TargetedWrite, RunAddPackage),
